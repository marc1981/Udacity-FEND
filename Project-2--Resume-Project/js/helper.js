                            ...
                            <div class="item"> \
                              <img class="slide-image" src="images/cells.jpg" style="height:210px"> \
                                <div class="carousel-caption"> \
                                  ...
                                  <p class="image-description">From high-throughput screening, to protein purification, to whole-cell recording, and a vast array of other procedures.</p> \
                                </div> \
                              </div> \
                              <div class="item"> \
...
var HTMLschoolDissertation = '<div class="honors-dissertation" id="#dissertation_title" data-toggle="modal" data-target="#dissertationDescription">Title of Disseration: %data%</div>';
...
var internationalizeButton = '<button class="ibutton">Internationalize My Name!</button>';
var googleMap = '<div id="map"></div>';
var cssCheck = '<p class="verified"> \
